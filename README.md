...
### 02 — Phase Sweep
Runs the MZI 50 times, sweeping θ continuously from 0 to 2π. Plots the full interference pattern showing how $P(|1\rangle)$ follows a smooth sine curve — controlled entirely by phase.
